...
var helpers = {
  initialize: function (props) {
    ...
    const slickTrack = ReactDOM.findDOMNode(this.track) || ReactDOM.findDOMNode(slickList.childNodes[0]);
    const slickThis = ReactDOM.findDOMNode(this) || ReactDOM.findDOMNode(slickList.parentNode);
